@tool
@icon("res://utilities/OvaniPlugin/OvaniPlayerIcon.png")
...
## Checking this will make the Queue send finished songs to the end of the queue, to infinitely loop music.
